...
const expenseTwo = store.dispatch(
  addExpense({ description: 'Coffee', amount: 175, createdAt: -1000 }),
);

const expenseThree = store.dispatch(addExpense({ amount: 350, createdAt: 998 }));

// store.dispatch(removeExpense({ id: expenseOne.expense.id }));
// store.dispatch(editExpense(expenseTwo.expense.id, { amount: 333, note: 'Minha expense' }));
// store.dispatch(setTextFilter('aluguél'));
